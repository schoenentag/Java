...
public class StringGame {
	...
	// Field 선언
	private String[] strDate = { "Orange", "Game", "Phone", "Smart" };
	private String strAnswer; // 정답을 담을 변수
	private List<Character> charData;
	public StringGame() {
		init(); //생성자에 호출해야지 쓸수 있음
	...
	private String getStrAnswer() {
		return strDate[(int) (Math.random() * 4)].toLowerCase(); // 0~3, 소문자로 전환
	}
